...
【關鍵要求】：
1. 餐點名稱 (mealName)：請務必「直接且專業」，例如「炭烤牛肉吉士堡」或「舒肥雞胸溫沙拉」，嚴禁使用「美味享受」、「流口水」等虛浮形容詞。
2. 營養師評語 (chefNote)：請以「資深執業營養師」的專業口吻，針對該餐點的巨量營養比例 (P/C/F) 提供深度的科學分析與具體調整建議（如：GI值影響、鈉含量提醒、或下一餐的補償建議）。嚴禁提供「均衡飲食」、「多吃水果」等籠統廢話。
3. 針對每個食材，請務必估計其「重量（克數）」。
